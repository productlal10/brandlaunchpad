...
export default function HomePage() {
  ...
  return (
    <div style={{ maxWidth: '100%', overflowX: 'hidden', fontFamily: "'Manrope', sans-serif", color: '#171615', background: '#FBFAF7' }}>
      ...
      {/* BRANDS MARQUEE (SCROLLING MONOCHROME LOGOS) */}
        ...
        <div className="brandscroll-anim" style={{ display: 'flex', width: 'max-content', alignItems: 'center' }}>
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '64px', paddingRight: '64px' }}>
            {BRAND_LOGOS.map((brand, idx) => (
              <div key={`brand-1-${idx}`} style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', minWidth: '110px' }}>
                <img 
                  src={brand.logo} 
                  alt={brand.name}
                  style={{ 
          ...
          <div aria-hidden="true" style={{ display: 'flex', alignItems: 'center', gap: '64px', paddingRight: '64px' }}>
            {BRAND_LOGOS.map((brand, idx) => (
              <div key={`brand-2-${idx}`} style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', minWidth: '110px' }}>
                <img 
                  src={brand.logo} 
                  alt={brand.name}
                  style={{ 
